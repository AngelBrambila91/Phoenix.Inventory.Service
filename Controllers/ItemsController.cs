...
namespace Phoenix.Inventory.Service.Controllers
{
    [ApiController]
    [Route("items")]
    public class ItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult> PostAsync(GrantItemsDto grantItemsDto)
        {
            ...
            item.UserId == grantItemsDto.UserId && item.CatalogGodId == grantItemsDto.CatalogGodId);

            if(inventoryItem is null)
            {
                inventoryItem = new InventoryItem
                {
                    CatalogGodId = grantItemsDto.CatalogGodId,
